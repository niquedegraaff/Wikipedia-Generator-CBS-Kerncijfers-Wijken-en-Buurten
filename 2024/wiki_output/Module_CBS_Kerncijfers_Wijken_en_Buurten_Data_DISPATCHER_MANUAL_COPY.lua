...
local function get_data_module(year)
    ...
    local module_path = 'Module:CBS_Kerncijfers_Wijken_en_Buurten_Data/' .. year -- Pad naar submodule, met Module: prefix!
...
function p.getStat(frame)
    ...
    if stat_alias == 'AantalInwoners' then internal_stat_key = 'AantalInwoners_5' end
    if stat_alias == 'Mannen' then internal_stat_key = 'Mannen_6' end
    if stat_alias == 'Vrouwen' then internal_stat_key = 'Vrouwen_7' end
    if stat_alias == 'Bevolkingsdichtheid' then internal_stat_key = 'Bevolkingsdichtheid_34' end
    if stat_alias == 'Woningvoorraad' then internal_stat_key = 'Woningvoorraad_35' end
    if stat_alias == 'OppervlakteTotaal' then internal_stat_key = 'OppervlakteTotaal_122' end
    if stat_alias == 'OppervlakteLand' then internal_stat_key = 'OppervlakteLand_123' end
    if stat_alias == 'OppervlakteWater' then internal_stat_key = 'OppervlakteWater_124' end
